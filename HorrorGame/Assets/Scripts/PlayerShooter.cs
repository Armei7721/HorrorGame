...
public class PlayerShooter : MonoBehaviour {
    ...
    private void OnAnimatorIK(int layerIndex) {
        ...
        gunPivot.position = FirePosition.position;
        ...
        playerAnimator.SetIKPositionWeight(AvatarIKGoal.RightHand, 0.0f);
        playerAnimator.SetIKRotationWeight(AvatarIKGoal.RightHand, 0.0f);
